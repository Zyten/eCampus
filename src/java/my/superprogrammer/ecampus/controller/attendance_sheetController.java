 ...
 */
@Controller
@RequestMapping(value = "/attendance_sheet.htm")
public class attendance_sheetController {
    
    EntityManagerFactory factory;
    int status = 1;
    
    @RequestMapping(method = RequestMethod.GET)
    public String processForm(ModelMap map, String uname, String pcode) throws Exception {
