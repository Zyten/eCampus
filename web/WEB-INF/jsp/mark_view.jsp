                ...
                <section class="page container">
                    ...
                    <table class="table table-bordered table-condensed">
                        ...
                        <tbody>
                            ...
                            <form action="${pageContext.request.contextPath}/mark_view.htm" method="post">  
                                <tr>
                                    <td>${loop.count}</td>
                                    ...
                                    <td><input type="text" name="masgmnt"></td>
                                    <td><input type="text" name="mquiz"></td>
                                    <td><input type="text" name="mfinal"></td>
                    ...
                    <a href="${pageContext.request.contextPath}/mark.htm"><button>Back</button></a> <br /><br />
                                        </section>
