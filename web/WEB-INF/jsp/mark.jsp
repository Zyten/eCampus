                        ...
                        <tbody>
                            <c:forEach items="${getList}" var="data" varStatus="loop">
                                <tr>
                                    ...
                                    <td><a href="${pageContext.request.contextPath}/mark_view.htm?pcode=${data.progCodeIDprogramme}">Update</a> | <a href="${pageContext.request.contextPath}/mark_print.htm?pcode=${data.progCodeIDprogramme}">Print</a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
