...
<body>
            ...
            <div class="row">
                <div class="span7">
                    <header class="page-header">
                        <h3>Configuration<br/>
                            <small>Types of Configuration</small>
                        </h3>
                    </header>
                </div>
    ...
    <section class="page container"><br><br><br>
		<table border="0" align="center">
			<tr align="center">
                            <td><a href="${pageContext.request.contextPath}/configuration_grade.htm"><img src="${pageContext.request.contextPath}/images/book.png" alt="Mark & Grading Configuration" width="80" height="80"></a><br>Mark &amp; Grading Configuration</td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td><a href="${pageContext.request.contextPath}/configuration_program_main.htm"><img src="${pageContext.request.contextPath}/images/program.png" alt="Programme Configuration" width="80" height="80"></a><br>Programme Configuration</td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td><a href="${pageContext.request.contextPath}/configuration_register.htm"><img src="${pageContext.request.contextPath}/images/user.ico" alt="User Configuration" width="80" height="80"></a><br>User Configuration</td>
			</tr>
		</table>
    </section>
