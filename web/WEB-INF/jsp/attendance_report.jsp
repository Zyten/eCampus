        ...
        <div id="body-container">
            <div id="body-content">
                ...
                <section class="page container">
                    <center><img src="http://gates.edu.my/register/img/FB-GAcademy.png" width="150px"></center>
                    <br>
                        ...
                        <tbody>
                            ...
                            <form action="${pageContext.request.contextPath}/attendance_update.htm" method="post">  
                                <tr>
                                    ...
                                    <td>${data.week1Attendance}</td>
                                    <td>${data.week2Attendance}</td>
                                    <td>${data.week3Attendance}</td>
                                    <td>${data.week4Attendance}</td>
                                    <td>${data.nricApplicant}<center><input type="submit" value="Update"><br></td>
                                            </tr>
                                            </form>
                                        </c:forEach>
                                        </tbody>
                                        ...
                                        <a href="${pageContext.request.contextPath}/attendance.htm"><button>Back</button></a> <a href="#"><button>Print</button></a><br /><br />
                                        </section>
                                        ...
                                        pt src="${pageContext.request.contextPath}/js/bootstrap/bootstrap-typeahead.js" type="text/javascript"></script>
                                        <script src="${pageContext.request.contextPath}/js/jquery/jquery-chosen.js" type="text/javascript"></script>
                                        <script src="${pageContext.request.contextPath}/js/jquery/jquery-tablesorter.js" type="text/javascript"></script>
                                        <script src="${pageContext.request.contextPath}/js/jquery/virtual-tour.js" type="text/javascript"></script>
