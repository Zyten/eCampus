        ...
        <div id="body-container">
            <div id="body-content">
                ...
                <section class="page container"><br>
                    <form action='${pageContext.request.contextPath}/configuration_register.htm' method='POST' id='registerForm' class='form-signin' autocomplete='off'>
                        <table border="0" align="center" width="300" align="center">
                            <tr>
                                <td>Username</td>
                                <td> : </td>
