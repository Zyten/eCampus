                        ...
                        <thead align="center">
                            ...
                            <c:forEach items="${applicantList}" var="item" varStatus="loop"><!-- tags from the prefix-->
                                <tr>
                                    ...
                                    <td><a href="${pageContext.request.contextPath}/certificate_print.htm?appID=${item.applicantIDapplicant}">Print</a></td>
                                    <td><a href="${pageContext.request.contextPath}/certificate_edit.htm?appID=${item.applicantIDapplicant}">Edit</a></td>
                                </tr>
                            </c:forEach>		
                            </tbody>
                    </table>
                     <a href="${pageContext.request.contextPath}/certificate.htm"><button>Back</button></a> <br /><br />
                </section>
