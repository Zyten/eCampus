...
<body>
    ...
    <section class="page container">
		...
		<table border="0" align="center" background="${pageContext.request.contextPath}/images/cert.png" width="808" height="610">
			<tr>
				<td></td>
			</tr>
			<tr>
			...
			<tr align="center">
				<td><br>${item.nameApplicant}</td>
			</tr>
			<tr align="center">
				<td><br>${item.pcodeApplicant}</td>
			</tr>
			<tr>
				<td><br></td>
			</tr>
