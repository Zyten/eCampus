        ...
        <div id="body-container">
            <div id="body-content">
                ...
                <section class="page container">
                    ...
                    <table class="table table-condensed" border="0">
                        ...
                        <tbody>
                            ...
                            <form action="${pageContext.request.contextPath}/attendance_update.htm" method="post">  
                                <tr>
                                    <td>${loop.count}</td>
                                    <td>${data.applicantIDapplicant}</td>
                    ...
                    <a href="${pageContext.request.contextPath}/attendance.htm"><button>Back</button></a> <a href="#"><button>Print</button></a>
                </section>
