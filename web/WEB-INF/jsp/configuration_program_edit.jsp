...
<body>
    ...
    <section class="page container"><br><br><br>
        <form role="form" action="${pageContext.request.contextPath}/configuration_program_edit.htm" method="post" class="registration-form">
		<table border="0" align="center">
                    <c:forEach items="${myList}" var="item">
			<tr>
				<td>Programme Code</td>
				<td> : </td>
				<td><input name="pcode" type="hidden" value="${item.progCodeIDprogramme}">${item.progCodeIDprogramme}</td>
			</tr>
			<tr>
				<td>Programme Name</td>
				<td> : </td>
				<td><input name="pname" type="text" value="${item.progNameprogramme}"></td>
			</tr>
			<tr>
				<td>Course Duration (Months)</td>
				<td> : </td>
				<td><input name="duration" type="text" value="${item.progDurationprogramme}"></td>
			</tr>
			<tr align="right">
                            <td colspan="3"><input type="submit" value="Update"></a>&nbsp;&nbsp;<input type="reset" name="reset" value="Reset"></td>
			</tr>
                        </c:forEach>
		</table>
        </form>
                <a href="${pageContext.request.contextPath}/configuration_program_main.htm"><button>Back</button></a><br /><br/>
    </section>
